 ...
 */
var PhraseView = /*#__PURE__*/function (_Component) {
  _inherits(PhraseView, _Component);

  var _super = _createSuper(PhraseView);
  ...
  _createClass(PhraseView, [{
    ...
    value: function getItems() {
      ...
      _axios.default.get("https://emotionner.herokuapp.com/users/getLastEmotion/".concat(id)).then(function (response) {
        ...
        if (Array.isArray(emotionArray) && emotionArray.length) {
          ...
          _axios.default.get("https://emotionner.herokuapp.com/phrases/selectPhrase/".concat(id2)).then(function (response) {
            var phrases = response.data.phrase;
    ...
    value: function render() {
      return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_reactstrap.Container, {
        className: "container"
      }, /*#__PURE__*/_react.default.createElement(_reactstrap.Row, null, /*#__PURE__*/_react.default.createElement(_reactstrap.Col, null, /*#__PURE__*/_react.default.createElement(_phrases.default, {
...
var _default = PhraseView;
exports.default = _default;

//# sourceMappingURL=PhraseF.js.map